...
def parse_args():
    ...
    parser.add_argument(
        "--corruption", type=str, default="pixelate"
    )
    ...
    parser.add_argument(
        "--adv_trade_off",action="store_true",default=False
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Name for plot saving"
    )

    parser.add_argument(
        "--fm",
        type=str,
        default="layerwise_trace",
        help="Flatness Measure"
    )
    parser.add_argument(
        "--approximate",
        action="store_true",
    ...
    parser.add_argument(
        ...
        type=str,
        default="hessian",
        choices=("base", "adv", "hessian", "mixtrain", "ibp", "smooth", "freeadv"),
