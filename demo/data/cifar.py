...
class CIFAR_Args():
    ...
    def __init__(self, data_dir, batch_size, test_batch_size):
...
class CIFAR10:
    ...
    def __init__(self, args=None, normalize=False, data_dir="", batch_size=128, test_batch_size=128):

        if args is None:
            args=CIFAR_Args(data_dir, batch_size,test_batch_size)
