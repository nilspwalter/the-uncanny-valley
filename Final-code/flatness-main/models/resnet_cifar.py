...
def DenseNet121(conv_layer, linear_layer, init_type, **kwargs):
    def forward(self, x, ret_act=False):
        ...
        if ret_act:
            return pred, out
        return pred
    torchvision.models.densenet.DenseNet.forward = forward
    return torchvision.models.densenet121(num_classes=kwargs["num_classes"])
